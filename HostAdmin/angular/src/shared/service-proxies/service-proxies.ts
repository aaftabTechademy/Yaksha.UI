...
const routes = {
    ...
    getTenantUser: 'platform/User/GetTenantUserByNameAsync',
    getTenantUsers: 'platform/User/GetAllUsersUnderTenant',
    getUsersUnderManager: 'platform/User/GetUsersUnderManager',
    getAllTenantUsers: 'platform/User/GetAll',
...
export class TenantServiceProxy {
     ...
     * @return Success
     */
    getByName(name: string | null | undefined, isDisableDeletedFilter: boolean = false): Observable<TenantDto> {
        let url_ = this.baseUrl + "/api/services/platform/Tenant/GetByName?";
        if (name !== undefined)
            url_ += "name=" + encodeURIComponent("" + name) + "&";
        url_ += "isDisableDeleteFilter=" + encodeURIComponent("" + isDisableDeletedFilter) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    GetIDProvider(tenantName: string, siteReferrer: string): Observable<string> {
        if (!siteReferrer)
            siteReferrer = "";
        let url_ = `${this.baseUrl}/api/services/platform/Tenant/GetIDProvider?tenancyName=${tenantName}&referrer=${encodeURI(siteReferrer)}`;
        let options_: any = {
            observe: "response",
            responseType: "blob",
            headers: new HttpHeaders({
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    adminResetPassword(input: ResetPasswordDto | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/platform/User/AdminResetPassword";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, TenantId: number | null | undefined, isActive: boolean | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfUserDto> {
    ...
    userImport(file): Observable<any> {
        return this.apiClient.platformPost(routes.importUsers, file);
    }

    forgotPassword(data): Observable<any> {
        return this.apiClient.platformPost(routes.forgotPassword, data);
    }

    logout(): Observable<any> {
        return this.apiClient.platformPost(routes.logout);
    }

    resetNewPassword(data): Observable<any> {
        return this.apiClient.platformPost(routes.resetPassword, data);
    }

    getTenantUser(userName, tenantId?, isDisableDeletedFilter = false): Observable<any> {
        if (tenantId)
            return this.apiClient.platformGet(routes.getTenantUser + "?tenantId=" + tenantId + "&userName=" + userName + "&isDisableDeletedFilter=" + isDisableDeletedFilter);
        else
            return this.apiClient.platformGet(routes.getTenantUser + "?userName=" + userName + "&isDisableDeletedFilter=" + isDisableDeletedFilter);
    }

    getUsersUnderManager(tenantId: number, managerId: number): Observable<any> {
            return this.apiClient.platformGet(routes.getUsersUnderManager + "?tenantId=" + tenantId + "&managerId=" + managerId);
    }

    getTenantUsers(tenantId, isActive = true, skipCount?: number, maxCount?: number) {
        if (tenantId && skipCount !== undefined && maxCount !== undefined) {
            return this.apiClient.platformGet(routes.getTenantUsers + "?isActive=" + isActive + "&tenantId=" + tenantId + "&maxCount=" + maxCount + "&skipCount=" + skipCount);
        }
        else if (skipCount !== undefined && maxCount !== undefined) {
            return this.apiClient.platformGet(routes.getTenantUsers + "?isActive=" + isActive + "&maxCount=" + maxCount + "&skipCount=" + skipCount);
        }
        else if (tenantId) {
            return this.apiClient.platformGet(routes.getTenantUsers + "?isActive=" + isActive + "&tenantId=" + tenantId);
        }
        else {
            return this.apiClient.platformGet(routes.getTenantUsers + "?isActive=" + isActive);
        }
    }

    getAllTenantUsers(tenantId) {
        if (tenantId) {
            return this.apiClient.platformGet(routes.getAllTenantUsers + "?tenantId=" + tenantId);
        }
        else {
            return this.apiClient.platformGet(routes.getAllTenantUsers);
        }
    }
